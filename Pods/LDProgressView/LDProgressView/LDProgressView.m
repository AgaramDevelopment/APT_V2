...
- (void)drawRightAlignedLabelInRect:(CGRect)rect {
    if (rect.size.width > 40) {
        ...
        label.text = self.progressTextOverride ? self.progressTextOverride : [NSString stringWithFormat:@"%.01f%%", self.progress*100];
        label.font = [UIFont boldSystemFontOfSize:11-self.progressInset.floatValue*1.75];
